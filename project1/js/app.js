...
search.addEventListener('input', function () {
  ...
  Array.from(noteCards).forEach(function (element) {
    let cardTxt = element.getElementsByTagName('p')[0].innerText//Har element ke andar ek hi <p> h - using innertext is very important, because we can use .includes() function only with a string
    // console.log(cardTxt)
